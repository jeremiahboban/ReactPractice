...
function AddEmployee(props) {
  ...
  return (
    <>
      <button onClick={handleShow} className="block mx-auto m-2 bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded-full">
                    + Add Employee
                </button>
            ...
            <form onSubmit={(e) => {
                ...
                <div className="md:flex md:items-center mb-6">
                    ...
                    <input 
                        ...
                        type="text" 
                        value={name}
                        onChange={(e) => {setName(e.target.value)}} //e is just a random variable name
                         />
                    </div>
                </div>
                <div className="md:flex md:items-center mb-6">
